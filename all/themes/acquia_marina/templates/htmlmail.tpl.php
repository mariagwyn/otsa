...
<div style="width: 95%; border-bottom: 2px solid #5A82BF; padding: 10px; margin: 0 0 30px 0;">
  <a href="http://otsamerica.org" style="float:left; margin: 0 20px;"><img src="http://dev.otsamerica.org/sites/all/themes/pix/otsa_logo-blue_sm.png"></a> 
<h2 style="margin: 0 0 0 20px; display:block; color: #5A82BF; width: 300px;"><a href="http://otsamerica.org" style="text-decoration:none; color: #5A82BF;">The Orthodox Theological Society in America</a></h2>
</div>
<?php echo $body; ?>
</div>
<hr />
<div style="font: .9em  #5A82BF;">
  <p>This is an automated email sent from <a href="http://otsamerica.org" style="text-decoration:none;">http://otsamerica.org.</a>  You are receiving this message because you have registered on the OTSA website.</p>
</div>
<?php if ($debug):
